const books = [
    ...
    { title: 'La disparition', id: 364445, rented: 23},
    { title: 'La lune seule le sait', id: 63541, rented: 43 },
    { title: 'Voyage au centre de la Terre', id: 4656388, rented: 38 },
    { title: 'Guerre et Paix', id: 748147, rented: 19 }
  ];

console.log("Il y a t'il des livres jamais empruntés ?");

function atLeastOne(books) {
    if (books.rented > 0 ) {
        console.log("Ils ont tous été empruntées au moins une fois");
    }
    else {
        console.log("Il doivent être vraiment nuls");
    }
}
console.log(books.filter(atLeastOne));
